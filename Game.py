...
class Game:
    ...
    def draw_text(self, dd_num, flag=False):
        ...
        start = "开始" if self.start_flag else "暂停"
    ...
    def start(self, time):
        ...
        while True:
            ...
            if not self.start_flag:
                if flag:
                    self.draw_text(round_times, flag)
                    pygame.display.update()
                    continue
                ...
                # 2.细胞改变生命
                after_list = self.cell_list.change_life()
                # 判断是否到达平衡状态
                ...
                round_times = round_times if self.start_flag else round_times + 1
